      ...
      <div className="min-h-screen bg-neutral-950 text-white">
        ...
        <div className="max-w-6xl mx-auto px-6 py-10 space-y-6">
            ...
            {landing.sessions.map((session) => (
              ...
              >
                ...
                <div className="p-4 space-y-1">
                  ...
                  <p className="text-sm text-neutral-400">Album #{session.album_id}</p>
                </div>
              </Link>
            ))}
          </div>
          ...
          {landing.sessions.length === 0 && (
            <div className="text-neutral-400 text-center py-16 border border-dashed border-white/10 rounded-2xl">
